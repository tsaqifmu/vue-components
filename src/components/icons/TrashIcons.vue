...
export interface TrashIconsProps {
  size?: number | string
  class?: string
}

const props = withDefaults(defineProps<TrashIconsProps>(), {
  size: 20,
})
</script>
...
<template>
  ...
  >
    ...
    <path
      ...
      stroke-linecap="round"
    />
    <path d="M7.91675 13.75V8.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
    <path d="M12.0833 13.75V8.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
  </svg>
</template>
