    ...
    <div class="mx-auto max-w-6xl space-y-12">
      ...
      <div class="space-y-4">
        ...
        <div class="rounded-lg border border-gray-200 p-6">
          ...
          <Button @click="isBasicOpen = true" variant="default"> Open Basic Modal </Button>
        ...
        <div class="rounded-lg border border-gray-200 p-6">
          ...
          <Button @click="isSmallOpen = true" variant="default"> Open Small Modal </Button>
        ...
        <div class="rounded-lg border border-gray-200 p-6">
          ...
          <Button @click="isLargeOpen = true" variant="default"> Open Large Modal </Button>
          ...
          <ModalRoot v-model:open="isLargeOpen">
            ...
            <ModalContent size="lg">
              ...
              <ModalBody>
                ...
                <p class="mb-4">
                  The body section will automatically scroll if the content exceeds the maximum
                  height of the modal.
                </p>

                <h3 class="mb-2 text-lg font-semibold">Section 3</h3>
                <p class="mb-4">
                  This makes it perfect for forms, settings panels, or detailed information
                  displays.
                </p>
        ...
        <div class="rounded-lg border border-gray-200 p-6">
          ...
          <Button @click="isNoFooterOpen = true" variant="default"> Open No Footer Modal </Button>
          ...
          <ModalRoot v-model:open="isNoFooterOpen">
            ...
            <ModalContent size="sm">
              ...
              <ModalBody>
                <p class="mb-4">
                  Sometimes you don't need a footer. This modal can be closed using the X button,
                  the Escape key, or by clicking outside.
                </p>
        ...
        <div class="rounded-lg border border-gray-200 p-6">
          ...
          <Button @click="isFormOpen = true" variant="default"> Open Form Modal </Button>
                ...
                <form @submit.prevent="handleFormSubmit" id="ticketForm" class="space-y-5">
                  ...
                  <div class="rounded-md bg-indigo-50 p-3">
                    <p class="text-xs text-indigo-800">
                      ...
                      Select components are specifically designed for form inputs with v-model
                      support and visual indicators. Both work perfectly inside modals with proper
                      z-index and teleport!
                    </p>
                  </div>
                </form>
              </ModalBody>
