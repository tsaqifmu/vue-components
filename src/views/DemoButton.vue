...
import TrashIcons from '@/components/icons/TrashIcons.vue'
            ...
            <DevelopmentStatus status="stable">
              <div class="flex items-center justify-between gap-4">
                ...
                <div class="flex gap-2">
                  ...
                  <Button variant="ghost" size="icon" rounded>
                    <TrashIcons size="20" />
                  </Button>
                </div>
              </div>
          ...
          <div class="flex flex-col gap-4">
            <DevelopmentStatus status="stable">
              <div class="flex flex-wrap gap-4">
                ...
                <Button variant="ghost" inactive>Ghost inactive</Button>
                <Button variant="link" inactive>Link inactive</Button>
                <Button variant="ghost" size="icon" inactive>
                  <TrashIcons size="20" />
                </Button>
              </div>
            </DevelopmentStatus>
